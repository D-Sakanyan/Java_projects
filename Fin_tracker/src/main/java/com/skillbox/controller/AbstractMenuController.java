...
import com.skillbox.exception.InvalidUserInput;
...
public abstract class AbstractMenuController<E extends Enum<E> & MenuOption> {
     ...
     */
    protected E selectMenu() throws InvalidUserInput {
        int option;
        ...
        while (true) {
            ...
            try {
                ...
                if (!numOptions.contains(option))
                    throw new InvalidUserInput("Выбрана неверная опция!\nПопробуйте заново.\n");
                break;
            } catch (InputMismatchException e) {
                System.err.println("Вводите число!\n");
                scanner.nextLine();
